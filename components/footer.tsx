            ...
            <div className="mx-auto max-w-screen-xl">
                <div >
                    <div className="mb-6 md:mb-0">
                        <a href="#" className="items-center inline-flex">
                            <img src="logo.png" className="mr-2 h-8" alt="Logo" />
                            <span className="self-center text-2xl font-semibold whitespace-nowrap">
                                <span className="text-green-600">프라임</span>
                                <span className="text-green-400">병원</span>
                            </span>
                        </a>
                        <div className="md:grid md:grid-cols-2">
                            <div>
                                <p className="self-center text-xs text-gray-500">대표상담전화 <span className="text-lg font-semibold text-green-400">051-202-7800</span></p>
                                <p className="text-xs text-gray-500">
                                    평 일 : 09:00 ~ 18:00 (점심 12:30 ~ 13:30)
                                    </p>
                                <p className="text-xs text-gray-500">
                                    토요일 : 09:00 ~ 13:00 일요일 : 휴 진
                                </p>
                                
                                <p className="text-xs text-gray-500 mt-2">
                                부산광역시 사하구 낙동남로 1410 프라임병원
                                </p>
                                <p className="text-xs text-gray-500">
                                1410, Nakdongnam-ro, Saha-gu, Busan, Republic of Korea
                                </p>
                                <p className="text-xs text-gray-500">
                                프라임병원 최봉식 사업자등록번호 603-90-26381
                                </p>
                                <p className="text-xs text-gray-500">
                                Tel. 051-202-7800 ㅣ Fax. 051-208-2439
                                </p>
                            </div>
                            <div className="grid grid-cols-2 gap-4 mt-4 sm:mt-0 sm:gap-6 sm:grid-cols-3">
                                <div>
                                    <ul className="text-gray-500 text-sm">
                                        <li>
                                            <a href="#" className="hover:underline ">비급여안내</a>
                                        </li>
                                        <li>
                                ...
                                <div>
                                    <ul className="text-gray-500 text-sm">
                                        ...
                                        <li>
                                            <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">환자권리장전</a>
                                        </li>
                                        <li>
                                            <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">이메일무단수집거부</a>
                                        </li>
                                    </ul>
                                </div>
                                <div>
                                    <ul className="text-gray-500 text-sm">
                                        <li>
                                            <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">병원윤리강령</a>
                                        </li>
                                        <li>
                                            <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">관리자페이지</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>    
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com" className="hover:underline">Sukbong</a>. All Rights Reserved.
                    </span>
